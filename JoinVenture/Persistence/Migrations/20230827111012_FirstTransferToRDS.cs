...
{
    /// <inheritdoc />
    public partial class FirstTransferToRDS : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidatedDateStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ValidatedDateEnd = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BookingAvailableStart = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BookingAvailableEnd = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TicketPackageId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookedTicketPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookedTicketPackages_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookedTicketPackages_OrderId",
