                ...
                <div class="table">
                    ...
                    <div class="ftr">
                        ...
                        <div class="btn-wrapper">
                            <div class="ftr text-center"> <a href="https://fff5-2402-7500-4d5-a113-e930-21d7-3d9c-cf18.ngrok-free.app/Client/Activity-Detail.html?id=${activity.id}" class="btn btn-black btn-round btn-info">View</a> </div>
...
$(document).ready(function () {
  axios
    ...
    .then(function (response) {
      ...
      // Loop through activities and create card elements
      activities.forEach(function (activity, index) {
        ...
        const columnIndex = index % 3; // Calculate column index (0, 1, or 2)

        // Append new card to the appropriate column
